...
export const useStore = create<MyState>(
  (persist as MyPersist)(
    (set) => ({
      ...
      setTraderScoreDbUrl: (_traderScoreDbUrl: string) => set({ traderScoreDbUrl: _traderScoreDbUrl}),
      setDiamondScoreDbUrl: (_diamondScoreDbUrl: string) => set({ diamondScoreDbUrl: _diamondScoreDbUrl}),
